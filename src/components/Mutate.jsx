    ...
    <>
      ...
      <div className="flex flex-col gap-4 p-4 border drop-shadow-sm rounded-md">
        <div className="flex xs:flex-row flex-col justify-between w-full">
          ...
          <div className="relative xs:w-auto w-full">
            <button
              id="dropdownSearchWalletButton"
              data-dropdown-toggle="dropdownSearchWallet"
              ...
              type="button"
            >
              {wallet ? wallet.title : "Pilih Wallet"}
              <svg
            ...
            <div
              id="dropdownSearchWallet"
              className="z-10 hidden bg-white rounded-lg shadow w-60 dark:bg-gray-700"
            >
              <div className="p-3">
                <label htmlFor="input-group-search-wallet" className="sr-only">
                  Search
                </label>
              ...
              <ul
                ...
                aria-labelledby="dropdownSearchWalletButton"
              >
                {listWallet
                  .filter((wallet) =>
                  ...
                  .map((wallet) => (
                    <li key={wallet.properties.index}>
                      <div className="flex items-center ps-2 rounded hover:bg-gray-100 dark:hover:bg-gray-600">
                        <input
                          id={`radio-item-wallet-${wallet.properties.index}`}
                          type="radio"
                          name="wallet"
                          onChange={() => setWallet(wallet.properties)}
                          value={wallet.properties.title}
                          className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 dark:focus:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                        />
                        <label
                          htmlFor={`radio-item-wallet-${wallet.properties.index}`}
